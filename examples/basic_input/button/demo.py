...
class ToolButtonDemo(ButtonView):
    ...
    def __init__(self):
        ...
        self.transparentDropDownToolButton = TransparentDropDownToolButton(
            FIF.MAIL, self
        )
...
class PushButtonDemo(ButtonView):
    ...
    def __init__(self):
        ...
        self.pushButton2 = PushButton(
            FIF.FOLDER, "Standard push button with icon", self
        )

        # primary color push button
        self.primaryButton1 = PrimaryPushButton("Accent style button", self)
        self.primaryButton2 = PrimaryPushButton(
            FIF.UPDATE, "Accent style button with icon", self
        )

        # transparent push button
        self.transparentPushButton1 = TransparentPushButton(
            "Transparent push button", self
        )
        self.transparentPushButton2 = TransparentPushButton(
            FIF.BOOK_SHELF, "Transparent push button", self
        )
        ...
        self.transparentTogglePushButton1 = TransparentTogglePushButton(
            "Transparent toggle button", self
        )
        self.transparentTogglePushButton2 = TransparentTogglePushButton(
            FIF.BOOK_SHELF, "Transparent toggle button", self
        )
        ...
        self.primaryDropDownPushButton2 = PrimaryDropDownPushButton(
            FIF.MAIL, "Email", self
        )
        ...
        # primary color drop down push button
        self.transparentDropDownPushButton1 = TransparentDropDownPushButton(
            "Email", self
        )
        self.transparentDropDownPushButton2 = TransparentDropDownPushButton(
            FIF.MAIL, "Email", self
        )
        ...
        self.primarySplitPushButton2 = PrimarySplitPushButton(
            FIF.GITHUB, "Split push button", self
        )
        ...
        self.hyperlinkButton1 = HyperlinkButton(
            url="https://qfluentwidgets.com", text="Hyper link button", parent=self
        )
        ...
        self.gridLayout.addWidget(
            self.dropDownPushButton1, 7, 0, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.dropDownPushButton2, 7, 1, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.primaryDropDownPushButton1, 8, 0, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.primaryDropDownPushButton2, 8, 1, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.transparentDropDownPushButton1, 9, 0, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.transparentDropDownPushButton2, 9, 1, Qt.AlignmentFlag.AlignLeft
        )

        self.gridLayout.addWidget(
            self.pillPushButton1, 10, 0, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.pillPushButton2, 10, 1, Qt.AlignmentFlag.AlignLeft
        )

        self.gridLayout.addWidget(
            self.hyperlinkButton1, 11, 0, Qt.AlignmentFlag.AlignLeft
        )
        self.gridLayout.addWidget(
            self.hyperlinkButton2, 11, 1, Qt.AlignmentFlag.AlignLeft
        )
